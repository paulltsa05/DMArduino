...
#ifndef LIST_MALLOC
//#define LIST_MALLOC malloc  (since malloc dzn work here)
#define LIST_MALLOC malloc //pvPortMalloc
#endif

#ifndef LIST_FREE
//#define LIST_FREE free   (since free dzn work here)
#define LIST_FREE free //vPortFree
#endif
...
//  int (*match)(void *a, void *b);
  int (*match)(uint16_t a, uint16_t b);
} list_t;
